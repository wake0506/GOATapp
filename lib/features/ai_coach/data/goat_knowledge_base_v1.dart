...
class GoatKnowledgeBaseV1 {
  ...
  static const entries = <KnowledgeEntry>[
    ...
    KnowledgeEntry(
      id: 'kb_nutrition_logging_completeness_v1',
      category: KnowledgeCategory.nutritionGeneral,
      title: '营养记录完整度',
      content: '不足七天的周营养观察只能基于已记录日期，不能据此断言完整周的热量趋势。',
      tags: ['partial_nutrition_logging', 'insufficient_data', 'data_quality'],
      applicableContexts: ['nutrition', 'weekly_review'],
      source: 'GOAT Stage 3B 场景规则',
      version: 1,
      stablePriority: 10,
    ),
    KnowledgeEntry(
      id: 'kb_ai_suggestion_confirmation_v1',
      category: KnowledgeCategory.goatRuleExplanations,
      title: '建议应用确认边界',
      content: 'AI 建议必须先预览影响范围并由用户确认，再经领域服务校验和持久化；失败时不得标记已应用。',
      tags: ['suggestion', 'confirmation', 'apply_boundary'],
      applicableContexts: ['suggestion', 'training', 'weekly_review'],
      source: 'GOAT Stage 3B 场景规则',
      version: 1,
      stablePriority: 10,
    ),
    KnowledgeEntry(
      id: 'kb_weekly_coach_review_v1',
      category: KnowledgeCategory.goatRuleExplanations,
      title: '周复盘事实边界',
      content: 'GOAT 周复盘只总结真实训练、营养、趋势体重和覆盖统计，不推断激素、代谢或医学恢复状态。',
      tags: ['weekly_review', 'data_quality', 'medical_boundary'],
      applicableContexts: ['training', 'weekly_review'],
      source: 'GOAT Stage 3B 场景规则',
      version: 1,
      stablePriority: 9,
