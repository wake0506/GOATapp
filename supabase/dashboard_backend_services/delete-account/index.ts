...
Deno.serve(async (request) => {
  ...
  const anon = Deno.env.get('SUPABASE_ANON_KEY') ?? key(Deno.env.get('SUPABASE_PUBLISHABLE_KEYS'));
  const secret = Deno.env.get('SUPABASE_SERVICE_ROLE_KEY') ?? key(Deno.env.get('SUPABASE_SECRET_KEYS'));
