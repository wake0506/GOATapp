-- GOAT production compatibility migration.
-- Generated for the confirmed production schema drift. Apply only after the
-- qasz regression and explicit production approval gates are complete.
